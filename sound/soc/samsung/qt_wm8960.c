...
static int smdk_audio_init(struct platform_device *pdev)
{
	int ret;
...
static int smdk_audio_exit(struct platform_device *pdev)
{
...
static struct platform_driver s5pv210_wm8960_driver = {
	.probe  = smdk_audio_init,
	.remove = smdk_audio_exit,
	.driver = {
		.name = "s5pv210_wm8960",
		.owner = THIS_MODULE,
	},
...
module_platform_driver(s5pv210_wm8960_driver);
